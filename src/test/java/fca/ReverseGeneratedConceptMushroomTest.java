...
public class ReverseGeneratedConceptMushroomTest {
    @Test
    public void testCombinationReduction() {
        try {
            ArrayList<Concept> concepts = LatticeFileHandler.readLatticeFromFile("src/main/java/data/lattice/mushroom_lattice.data.txt");
            ArrayList<BitSet> reductions = BitSetFileHandler.readFromFile("src/main/java/data/reduction/mushroom_reduction.data.txt");
    ...
    public void testReverseGeneratedContext() {
        try {
            ...
            Context context = File.readFile("src/main/java/data/context/mushroom.data.txt");
            ReverseGeneratedConcept.reverseGeneratedContext(context, combinationReduction, "mushroom");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void testReverseGeneratedConceptLatticeUsingExtents(){
        ...
        try {
            ArrayList<Concept> concepts = LatticeFileHandler.readLatticeFromFile("src/main/java/data/lattice/mushroom_lattice.data.txt");
            Context reverseContext = File.readFile("src/main/java/data/reverse_context/mushroom_reverse.data.txt");
            ReverseGeneratedConcept.reverseGeneratedConceptLatticeUsingExtents(concepts, reverseContext, "mushroom");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public void testReverseGeneratedConceptLatticeUsingIntents() {
        ...
        try {
            ...
            ArrayList<BitSet> reductions = BitSetFileHandler.readFromFile("src/main/java/data/reduction/mushroom_reduction.data.txt");
            ArrayList<Concept> combinationReduction = rc.combinationReduction(concepts, reductions);
            ReverseGeneratedConcept.reverseGeneratedConceptLatticeUsingIntents(context, concepts, combinationReduction, "mushroom");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        long endTime = System.currentTimeMillis();
